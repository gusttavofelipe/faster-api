...
def apply_operator[OrmModelT: DeclarativeBaseModel](
    ...
    elif op == "ne": return column != value
    elif op == "lt": return column < value
    elif op == "lte": return column <= value
    elif op == "gt": return column > value
    elif op == "gte": return column >= value
    elif op == "in": return column.in_(value)
...
def build_query[OrmModelT: DeclarativeBaseModel](
    ...
    if return_conditions: return conditions
